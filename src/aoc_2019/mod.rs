...
fn day_1_part_2_eg() -> Result<i32, Box<dyn std::error::Error>> {
    crate::aoc_2019::day_1::solution::part_2("src/aoc_2019/day_1/example.txt")
}
fn day_1_part_2() -> Result<i32, Box<dyn std::error::Error>> {
    crate::aoc_2019::day_1::solution::part_2("src/aoc_2019/day_1/input.txt")
}
