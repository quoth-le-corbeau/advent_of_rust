...
fn part_one_eg() -> Result<i32, Box<dyn std::error::Error>> {
    day_1::solution::part_one("src/aoc_2020/day_1/example.txt")
}
fn part_one() -> Result<i32, Box<dyn std::error::Error>> {
    day_1::solution::part_one("src/aoc_2020/day_1/input.txt")
}

fn part_two_eg() -> Result<i32, Box<dyn std::error::Error>> {
    day_1::solution::part_two("src/aoc_2020/day_1/example.txt")
}
fn part_two() -> Result<i32, Box<dyn std::error::Error>> {
    day_1::solution::part_two("src/aoc_2020/day_1/input.txt")
}